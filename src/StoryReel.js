...
const StoryReel = (props) => {
    ...
    return (
        <div className="storyReel">
            <Story profileSrc="./Logo/home-bg-2.jpg" image="./Logo/home-bg-2.jpg" title="Yogesh"/>
            ...
            <Story profileSrc="./Logo/home-bg-2.jpg" image="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcT7E2gifOhSOMW8ZGW2iJGu1M_V9UmevpyxWQ&usqp=CAU" title="Rajesh"/>
